...
public class KickoutController {
    ...
    // 将指定账号强制注销   ---- http://localhost:8080/kickout/logout?userId=10001
    ...
    // 将指定账号踢下线   ---- http://localhost:8080/kickout/kickout?userId=10001
    @RequestMapping("kickout")
    ...
    // 根据 Token 值踢人    ---- http://localhost:8080/kickout/kickoutByTokenValue?tokenValue=xxxx-xxxx-xxxx-xxxx已登录账号的token值
